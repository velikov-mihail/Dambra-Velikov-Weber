...
/* Plot Results */
proc sgplot data=IO_Stats;
Title 'Time Series of IO Statistics For US Common Stocks' ;
Title2 'Median Statistics in %'; format rdate year.;
series x=rdate y=IOR;
series x=rdate y=IO_MISSING ;
series x=rdate y=IOC_HHI;
series x=rdate y=IO_G1;
run;
